...
points = detectMinEigenFeatures(I,'MinQuality',0.02);
% points = detectFASTFeatures(I,'MinQuality',0.05,'MinContrast',0.01);
gridLocations = round([points.Location(:,2) points.Location(:,1)]);
